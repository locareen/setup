...
yay -S openssl pulseaudio pavucontrol vim fcitx-mozc bash-completion chromium git xf86-video-intel os-prober p7zip virtualbox linux-headers visual-studio-code update-grub
